...
public class Subscription {
		...
		public String toString() {
			return "Subscription [subscriptionId=" + subscriptionId + ", userName=" + username
					+ ", subscriptionStartDate=" + subscriptionStartDate + ", subscriptionEndDate="
					+ subscriptionEndDate + ", transactionId=" + transactionId + ", plan=" + plan + "]";
		}
